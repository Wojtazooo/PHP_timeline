...
$event1 = new Event(1, 'Concert', strtotime('25-10-2024'), strtotime('28-10-2024'), 'Live music event', 'concert.jpg', $category1->getId());
$event2 = new Event(2, 'Art Exhibition', strtotime('28-10-2024'), strtotime('28-10-2024'), 'Contemporary art showcase', 'art.jpg', $category1->getId());
$event3 = new Event(3, 'Tech Conference', strtotime('26-10-2024'), strtotime('27-10-2024'), 'Latest trends in technology', 'tech.jpg', $category2->getId());
